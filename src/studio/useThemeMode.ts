...
import { readMode, watchThemeMode } from '../config/theme';
 ...
 * nothing to select. Wrapping it in `useSyncExternalStore` means the Studio
 * follows both our toggle and the SDK's own.
 */
