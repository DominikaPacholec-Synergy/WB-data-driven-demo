...
/**
 * Custom JsonForms renderers, registered once for the whole app. Which FIELD
 * uses one is decided in `palette.json` via `options.customRenderer`.
 */
export const CUSTOM_RENDERERS: JsonFormsRendererExtension[] = [currencyAmountRenderer];
